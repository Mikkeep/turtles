...
-- ----------------------------
BEGIN;
INSERT INTO "rite_gcb" VALUES (2, 'Middle', 'TMNT!, pa', 0);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO "rite_pages" VALUES (1, 'home', 1, 'default', '', 1612220400, 0, 1614713657, 1, 'home', '', '', '', '', '', '', 'home', 0, 0, 0, 4, 'main_menu', '', '', 0, 0, 0, 'default.tpl', '', '', '', '', '', 1, '', '<p>TURTLES!</p>', 0, '[function:slideshow(''"April"::media/april.jpg||"Leonardo"::media/leonardo.png||"Raphael"::media/raphael.png||"Michelangelo"::media/michelangelo.png||"Donatello"::media/donatello.png'')]', 0, '', 0, '', 0, 'To create s slide show, just copy and past the following into Sidebar 1.
...
<p class="reviews">Its cool to be a ninja turtle!.</p>
...
<p>Its cool to be a ninja turtle!.</p>
<p>&nbsp;</p>
<p>Its cool to be a ninja turtle!</p>
<p>&nbsp;</p>
<p>Its cool to be a ninja turtle!</p>', 0, '', 0, '', 0, '', 0, '', '', 0, '', 2, 1, 0, '', '', 'mobile.tpl');
...
<p>Its cool to be a ninja turtle!</p>
<p>&nbsp;</p>
<p>Its cool to be a ninja turtle!</p>', 0, '', 0, '', 0, '', 0, '', '', 0, '', 2, 0, 0, '', '', 'mobile.tpl');
...
INSERT INTO "rite_settings" VALUES ('website_title', 'Turtles support site');
...
INSERT INTO "rite_settings" VALUES ('website_footnote_2', 'RiteCMS version v3.1.0');
